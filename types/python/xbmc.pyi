...
PLAYLIST_MUSIC: int
PLAYLIST_VIDEO: int
SERVER_AIRPLAYSERVER: int
SERVER_EVENTSERVER: int
SERVER_JSONRPCSERVER: int
SERVER_UPNPRENDERER: int
SERVER_UPNPSERVER: int
SERVER_WEBSERVER: int
SERVER_ZEROCONF: int
...
class VideoStreamDetail:
    ...
    **Video stream details class used in combination with `InfoTagVideo`.**
    ...
    Example::
        ...
        ...
    """
    def __init__(self, width: int = 0, height: int = 0, aspect: float = 0.0, duration: int = 0, codec: str = '', stereomode: str = '', language: str = '', hdrtype: str = '') -> None: ...
...
class InfoTagVideo:
    ...
    **Kodi's video info tag class.**
    ...
    def addSubtitleStream(self, stream: SubtitleStreamDetail) -> None:
        ...
        @python_v20 New function added.
        """
    def addAvailableArtwork(self, url: str, arttype: str = '', preview: str = '', referrer: str = '', cache: str = '', post: bool = False, isgz: bool = False, season: int = -1) -> None:
        '''
...
class Player:
    ...
    **Kodi's player.**
    ...
    """
    def __init__(self) -> None: ...
    def play(self, item: str | PlayList = '', listitem: xbmcgui.ListItem | None = None, windowed: bool = False, startpos: int = -1) -> None:
        """
        Play an item.
...
class PlayList:
    ...
    **Kodi's Play `List` class.**
    ...
    def getPlayListId(self) -> int:
        ...
        """
    def add(self, url: str, listitem: xbmcgui.ListItem | None = None, index: int = -1) -> None:
        """
...
def getSkinDir() -> str:
    ...
    Example::
        ...
        ..
    """
def getLanguage(format: int = ..., region: bool = False) -> str:
    '''
