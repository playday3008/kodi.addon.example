...
class CryptoSession:
    ...
    **Kodi's DRM class.**
    ...
    def GetKeyRequest(self, init: str | bytes | bytearray, mimeType: str, offlineKey: bool, optionalParameters: dict[str, str]) -> bytearray:
        '''
    ...
    def GetPropertyString(self, name: str) -> str:
        ...
        @python_v18 New function added.
        """
    def ProvideKeyResponse(self, response: str | bytes | bytearray) -> str:
        """
    ...
    def SetPropertyString(self, name: str, value: str) -> None:
        ...
        @python_v18 New function added.
        """
    def Decrypt(self, cipherKeyId: str | bytes | bytearray, input: str | bytes | bytearray, iv: str | bytes | bytearray) -> bytearray:
        """
        ...
        """
    def Encrypt(self, cipherKeyId: str | bytes | bytearray, input: str | bytes | bytearray, iv: str | bytes | bytearray) -> bytearray:
        """
        ...
        @python_v19 With python 3 all arguments need to be of type bytearray instead of byte.
        """
    def Sign(self, macKeyId: str | bytes | bytearray, message: str | bytes | bytearray) -> bytearray:
        """
        ...
        @python_v19 With python 3 all arguments need to be of type bytearray instead of byte.
        """
    def Verify(self, macKeyId: str | bytes | bytearray, message: str | bytes | bytearray, signature: str | bytes | bytearray) -> bool:
        """
